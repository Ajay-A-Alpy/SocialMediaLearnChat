import { AppBar, styled, Toolbar, Typography,Box, fabClasses } from "@mui/material";
...
export default function Navbar() {
    ...
    const SyledToolbar = styled(Toolbar)({ display: "flex", justifyContent: "space-between" })
    const Search = styled("div")({ backgroundColor: "white", borderRadius: "1rem", padding: "0 1rem", width: "40%" })
    const Icons = styled("div")({ display:"flex",gap:"1rem",alignItems:"center" })
    ...
    return (
        <AppBar position="sticky" >
            <SyledToolbar>
                <Typography variant="h6" sx={{ display: { xs: "none", sm: "block" } }} >  Learn-Chat</Typography>
