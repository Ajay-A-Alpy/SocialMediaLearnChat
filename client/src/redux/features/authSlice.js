...
export const getFollowersData=createAsyncThunk('auth/getfollowers', async({Id,navigate},{rejectWithValue})=>{
    try { 
...
export const getFollowingsData=createAsyncThunk('auth/getfollowings', async({Id,navigate},{rejectWithValue})=>{
    try { 
...
export const unFollowOne= createAsyncThunk("auth/unfollow",async ({userData,Id,navigate,toast},{rejectWithValue})=>{
    try{
